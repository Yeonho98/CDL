...
public class RegisterManagerCellphoneActivity extends AsyncTask<String, Void, String>  {
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            String str;
            URL url = new URL("http://146.56.165.103:8080/android/selectMgrInfo.jsp"); // 관리자 번호 넣기
