...
public class RegisterPasswordActivity extends AsyncTask<String, Void, String>  {
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            String str;
            URL url = new URL("http://146.56.165.103:8080/android/updateStudentPwProc.jsp"); // 1대1 문의 jsp
            ...
            sendMsg = "stu_code=" +strings[0]+ "&stu_pw=" + strings[1] ;
