...
public class RegisterPersonActivity extends AsyncTask<String, Void, String>  {
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            String str;
            URL url = new URL("http://146.56.165.103:8080/android/viewStudentInfo_mypage.jsp"); // 보내려는 주소
